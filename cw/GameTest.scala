...
// passed already these tests: 45, 38, 35, 27, 03, 11, 17.
...
class GameTest {
  ...
  @Test def test_22_save {
    ...
    assertEquals(40, game.getPoints())
  }
  ...
  @Test def test_41_maxpoints {
    var game: Game = GameBuilder.initialiseGame1()
    assertEquals(35, game.maxPoints())
    assertEquals((0,0), game.getPlayerPos())
    assertEquals(0, game.getPoints())
  }

  @Test def test_42_maxpoints {
    var game: Game = GameBuilder.initialiseGame2()
    game.move("ddds")
    assertEquals(40, game.maxPoints())
    assertEquals(20, game.getPoints())
  }

  @Test def test_43_maxpoints {
    var game: Game = GameBuilder.initialiseGame2()
    game.move("ddds")
    assertEquals(40, game.maxPoints())
    assertEquals(20, game.getPoints())
  ...
  @Test def test_48_checkcoins {
    ...
    game.setSavePos(0,0)
    game.checkCoins()
    assertEquals(35, game.getPoints())
    assertEquals((4,4), game.getPlayerPos())
  }
